...
namespace Assignment3TestSuite
{
    ...
    public class Assignment3Tests
    {
        ...
        /// 
        /// Testing Constrains 
        ///  dotnet test --filter "FullyQualifiedName~Constraint_ConnectionWithoutRequest_ShouldConnect"
        ////////////////////////////////////////////////////////// 
        ...
        [Fact]
        ///  dotnet test --filter "FullyQualifiedName~Constraint_RequestWithoutMethod_MissingMethodError"
        ...
        ///  dotnet test --filter "FullyQualifiedName~Constraint_RequestWithUnknownMethod_IllegalMethodError"
        ...
        ///  dotnet test --filter "FullyQualifiedName~Constraint_RequestForCreateReadUpdateDeleteWithoutResource_MissingResourceError" 
        [Theory]
        [InlineData("create")]
        [InlineData("read")]
        [InlineData("update")]
        ...
        /* Date Tests    */
        ///  dotnet test --filter "FullyQualifiedName~Constraint_Constraint_RequestWithoutDate_MissingDateError" 
        ...
        ///  dotnet test --filter "FullyQualifiedName~Constraint_Constraint_RequestWhereDateIsNotUnixTime_IllegalDateError" 
        ...
        /* Body Tests    */
        ///  dotnet test --filter "FullyQualifiedName~Constraint_Constraint_RequestForCreateUpdateEchoWithoutBody_MissingBodyError" 
        ...
        ///  dotnet test --filter "FullyQualifiedName~Constraint_Constraint_RequestUpdateWithoutJsonBody_IllegalBodyError" 
        ...
        ///  dotnet test --filter "FullyQualifiedName~Constraint_Echo_RequestWithBody_ReturnsBody" 
